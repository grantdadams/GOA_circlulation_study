...
norkdirectsem = "
  ...
  # --- Fall drivers (lag 2) ---
  NGAOr_fall               ->  recdevs1,                 3,  fallNGAOr_to_R,    0
  GOADIr_fall              ->  recdevs1,                 3,  fallGOADIr_to_R,   0
...
norksem_prey = "
  ...
  # --- Fall drivers (lag 2) ---
  NGAOr_fall               ->  recdevs1,                 2,  fallNGAOr_to_R,    0
  GOADIr_fall              ->  recdevs1,                 2,  fallGOADIr_to_R,   0
